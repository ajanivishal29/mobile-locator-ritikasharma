...
public class pgrs_Second_intro extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.pgrs_call_second_intro);

        context = pgrs_Second_intro.this;
        ...
        findViewById(R.id.continue_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                pgrs_Second_intro.this.startActivity(new Intent(pgrs_Second_intro.this, realocation_Privacy_PolicyActivity.class));
            }
        });
    }
}
