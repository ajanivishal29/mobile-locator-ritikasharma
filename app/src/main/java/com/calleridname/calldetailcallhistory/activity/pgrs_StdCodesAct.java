...
public class pgrs_StdCodesAct extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    /* renamed from: com.loctracker.findlocation.calldetailcallhistory.StdCodesAct$b */
    ...
    /* renamed from: com.loctracker.findlocation.calldetailcallhistory.StdCodesAct$c */
    public class C1724c implements View.OnClickListener {
        ...
        public void onClick(View view) {
            TextView textView;
            pgrs_StdCodesAct.m4620J(pgrs_StdCodesAct.this);
            if (pgrs_StdCodesAct.this.autocompletetextview.getText().toString().equals((Object) null) || pgrs_StdCodesAct.this.autocompletetextview.getText().toString().equals("")) {
                Toast.makeText(pgrs_StdCodesAct.this, "Select Value", 0).show();
                pgrs_StdCodesAct.this.constraintlayout.setVisibility(8);
                return;
            }
            pgrs_StdCodesAct.this.constraintlayout.setVisibility(0);
            pgrs_StdCodesAct.this.tv_cityname.setText("City Name:");
            pgrs_StdCodesAct.this.tv_stdcode.setText("STD Code:");
            CharSequence charSequence = "Unknown";
            if (Arrays.asList(pgrs_StdCodesAct.f6465F).contains(pgrs_StdCodesAct.this.autocompletetextview.getText().toString().trim())) {
                pgrs_StdCodesAct stdCodesAct = pgrs_StdCodesAct.this;
                stdCodesAct.city_name.setText(stdCodesAct.f6482z);
                pgrs_StdCodesAct stdCodesAct2 = pgrs_StdCodesAct.this;
                textView = stdCodesAct2.std_code;
                charSequence = stdCodesAct2.hashmao_array.get(stdCodesAct2.city_name.getText().toString());
            } else {
                pgrs_StdCodesAct.this.std_code.setText(charSequence);
                textView = pgrs_StdCodesAct.this.city_name;
            }
            textView.setText(charSequence);
        }
    }

    /* renamed from: com.loctracker.findlocation.calldetailcallhistory.StdCodesAct$d */
    public class C1725d implements View.OnClickListener {
        ...
        public void onClick(View view) {
            try {
                pgrs_StdCodesAct.this.view1.setVisibility(8);
                pgrs_StdCodesAct.this.view2.setVisibility(0);
                pgrs_StdCodesAct.this.autocompletetextview.setText((CharSequence) null);
                pgrs_StdCodesAct.this.autocompletetextview.setHint("Enter STD Code");
                pgrs_StdCodesAct.this.constraintlayout.setVisibility(8);
                pgrs_StdCodesAct.this.autocompletetextview.setInputType(2);
                pgrs_StdCodesAct.this.mo7233K();
            } catch (Exception unused) {
            }
        }
    }

    /* renamed from: com.loctracker.findlocation.calldetailcallhistory.StdCodesAct$e */
    public class C1726e implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            pgrs_StdCodesAct.this.tv_stdcode.setText("STD Code:");
            CharSequence charSequence = "Unknown";
            if (Arrays.asList(pgrs_StdCodesAct.f6466G).contains(pgrs_StdCodesAct.this.autocompletetextview.getText().toString().trim())) {
                pgrs_StdCodesAct stdCodesAct = pgrs_StdCodesAct.this;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pgrs_activity_std_codes);
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pgrs_StdCodesAct.this.onBackPressed();
            }
        });
    ...
    public void mo7232I() {
        ...
        pgrs_StdCodesAct.this.view2.setVisibility(8);
        pgrs_StdCodesAct.this.view1.setVisibility(0);
        pgrs_StdCodesAct.this.autocompletetextview.setText((CharSequence) null);
        pgrs_StdCodesAct.this.autocompletetextview.setHint("Enter City Name");
        pgrs_StdCodesAct.this.constraintlayout.setVisibility(8);
        pgrs_StdCodesAct.this.autocompletetextview.setInputType(1);
        int i = 0;
        while (true) {
